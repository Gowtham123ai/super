...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const tSales = sales.reduce((acc: number, s: any) => acc + (s.finalAmount || 0), 0);
                const tCredit = credits.reduce((acc: number, c: any) => acc + (c.amount || 0), 0);
    ...
    return (
        <motion.div
            ...
            style={{ flex: 1, padding: "32px", overflowY: "auto", background: "#1e293b", color: "white" }}
        >
            <h1 style={{ margin: "0 0 6px", fontSize: "24px" }}>Dashboard</h1>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
                <div style={{ background: "#0f172a", borderRadius: "14px", padding: "24px" }}>
                    <h3 style={{ color: "#94a3b8", marginBottom: "16px", fontSize: "13px", textTransform: "uppercase", letterSpacing: "0.5px" }}>
                        📊 Weekly Sales
                    </h3>
            ...
            <motion.div
                ...
                style={{ marginTop: "32px", background: "#0f172a", borderRadius: "14px", padding: "24px" }}
            >
                ...
                {creditsList.length === 0 ? (
                    ...
                    <div style={{ overflowX: "auto" }}>
                        <table style={{ width: "100%", borderCollapse: "collapse", color: "white", fontSize: "14px", textAlign: "left" }}>
                            ...
                            <tbody>
                                {creditsList.map((c, i) => (
                                    <tr key={c.id || i} style={{ borderBottom: "1px solid #1e293b", transition: "background 0.2s" }} onMouseEnter={e => e.currentTarget.style.background = "#1e293b"} onMouseLeave={e => e.currentTarget.style.background = "transparent"}>
